...
from src.projet_final_data_viz.agents import initialize_claude_client
from src.projet_final_data_viz.tapas_code import process_question
from src.projet_final_data_viz.display import setup_page_config, display_graph_suggestions
            ...
            with tabs[1]:
                ...
                st.markdown("""
                    **Example Queries:**
                    ...
                    - what's the  sum of [numeric column] by [column]
